...
const (
	StreamService_FetchResponse_FullMethodName = "/protobuf.streamService/FetchResponse"
)
...
func (c *streamServiceClient) FetchResponse(ctx context.Context, in *Request, opts ...grpc.CallOption) (StreamService_FetchResponseClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamService_ServiceDesc.Streams[0], StreamService_FetchResponse_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
